...
const CONFIG = {
  ...
  // ===== CHARACTERS =====
  CHARACTERS: {
    knight: { hp: 120, spd: 5.3, arm: 3, dm: 1, block: 0.15, abilityCD: 1420 },
    mage:   { hp: 80, spd: 5.5, arm: 0, dm: 1.2, expBonus: 1.3, abilityCD: 1480 },
    ranger: { hp: 100, spd: 5.1, arm: 1, dm: 1.05, cdBonus: 0.85, abilityCD: 1240 },
    necro:  { hp: 80, spd: 5.3, arm: 0, dm: 1.1, vamp: 0.05, abilityCD: 1360 },
    cyborg: { hp: 100, spd: 5.7, arm: 2, dm: 1.08, shieldMax: 30, shieldCD: 720, abilityCD: 1540 },
  },
  ...
  WEAPONS: {
    plasma_pistol:  { dm: 15, rate: 60, mag: 6, rld: 100,  spr: 0.05, spd: 7,  semiAuto: false },
    ...
    fire_launcher:  { dm: 10, rate: 72, mag: 6,  rld: 100, spr: 0.07, spd: 5,  semiAuto: false },
  ...
  ENEMIES: {
    slime:      { r: 10, spd: 2.45, hp: 40,  xp: 1, dm: 8 },
    ...
    // --- NEW ENEMIES ---
    bomber:     { r: 10, spd: 3.3,  hp: 30,  xp: 2, dm: 15, isBomber: true, explodeRadius: 55, explodeDmg: 25 },
    shielder:   { r: 13, spd: 1.68, hp: 180, xp: 4, dm: 10, hasShield: true, shieldHP: 60 },
    healer:     { r: 10, spd: 1.60, hp: 60,  xp: 4, dm: 7, isHealer: true, healRadius: 100, healAmount: 2, healCD: 90 },
    assassin:   { r: 9,  spd: 3.0,  hp: 40,  xp: 3, dm: 14, isAssassin: true, dashCD: 300, dashDist: 80 },
