...
const CONFIG = {
  ...
  // ===== CHARACTERS =====
  CHARACTERS: {
    knight: { hp: 120, spd: 2.3, arm: 3, dm: 1, block: 0.15, abilityCD: 420 },
    mage:   { hp: 80, spd: 2.5, arm: 0, dm: 1.2, expBonus: 1.3, abilityCD: 480 },
    ranger: { hp: 100, spd: 3.1, arm: 1, dm: 1.05, cdBonus: 0.85, abilityCD: 240 },
    necro:  { hp: 80, spd: 2.3, arm: 0, dm: 1.1, vamp: 0.05, abilityCD: 360 },
    cyborg: { hp: 100, spd: 2.7, arm: 2, dm: 1.08, shieldMax: 30, shieldCD: 720, abilityCD: 540 },
  },
  ...
  WEAPONS: {
    plasma_pistol:  { dm: 8, rate: 50, mag: 6, rld: 80,  spr: 0.05, spd: 7,  semiAuto: false },
    ...
    railgun:        { dm: 22, rate: 200, mag: 3,  rld: 160, spr: 0,    spd: 20, semiAuto: false },
  ...
  ENEMIES: {
    slime:      { r: 10, spd: 0.95, hp: 45,  xp: 1, dm: 8 },
    bat:        { r: 8,  spd: 1.65, hp: 25,  xp: 1, dm: 6 },
    skeleton:   { r: 11, spd: 1.05, hp: 65,  xp: 2, dm: 10 },
    spider:     { r: 9,  spd: 1.45, hp: 35,  xp: 1, dm: 7 },
    orc:        { r: 14, spd: 0.72, hp: 140, xp: 3, dm: 14 },
    mage_e:     { r: 11, spd: 0.78, hp: 75,  xp: 3, dm: 10, shoots: true, shootCD: 100 },
    ghost:      { r: 12, spd: 1.2,  hp: 55,  xp: 2, dm: 9, isGhost: true },
